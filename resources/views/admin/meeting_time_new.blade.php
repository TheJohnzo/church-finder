...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <form action="{{ URL::to('admin/church/' . $church->id . '/meetingtime/new') }}" method="POST">
                {{ Form::token() }}
                <table>
                    <tr>
                        ...
                        {{ Form::select('day_of_week', $days, old('day_of_week')) }}</td>
                    </tr><tr>
                        <td>&nbsp;</td><td></td>
                    </tr><tr>
                        <td class="form_cell_label">Time</td>
                        <td class="text form_cell">{{ Form::text('time', old('address'), [
                        ...
                        <td class="text form_cell">
                        {{ Form::select('address', $addresses, old('address')) }}
                        </td>
                    </tr><tr>
